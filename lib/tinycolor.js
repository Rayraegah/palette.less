(function() {
    ...
    function tinycolor(color, opts) {
        ...
        this._originalInput = color, this._r = rgb.r, this._g = rgb.g, this._b = rgb.b, this._a = rgb.a, this._roundA = mathRound(
            100 * this._a
        ) /
            100, this._format = opts.format || rgb.format;
    ...
    tinycolor.equals = function(color1, color2) {
        ...
        return tinycolor(color1).toRgbString() ==
